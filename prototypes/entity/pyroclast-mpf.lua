...
-- Two fluid inputs on the south edge of the 11x11 footprint
mpf.fluid_boxes = {
    {
        production_type = "input",
        pipe_connections = {
            { flow_direction = "input", direction = defines.direction.south, position = { -2, 5 } },
        },
        volume = 1000,
    },
    {
...
mpf.graphics_set = {
    animation = {
        north = mpf_sprite("south"),
        east  = mpf_sprite("east"),
        south = mpf_sprite("north"),
